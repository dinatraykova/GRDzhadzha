...
#ifndef LINEARMOMCONSERVATIONY_HPP_
#define LINEARMOMCONSERVATIONY_HPP_
...
template <class matter_t, class background_t> class LinearMomConservationY
{
  ...
  public:
    LinearMomConservationY(matter_t a_matter, background_t a_background,
    ...
    template <class data_t> void compute(Cell<data_t> current_cell) const
    {
        ...
        current_cell.store_vars(rhoLinMom, c_rhoLinMomY);
        current_cell.store_vars(fluxLinMom, c_fluxLinMomY);
        current_cell.store_vars(sourceLinMom, c_sourceLinMomY);
    }
};

#endif /* LINEARMOMCONSERVATIONY_HPP_ */
