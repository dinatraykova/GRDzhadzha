  ...
  public:
    ...
    template <class data_t> void compute(Cell<data_t> current_cell) const
    {
        ...
        const data_t max_abs_xyz_string = simd_max(
            abs(coords.x - (m_d_to_bh - m_velocity * m_time)), abs(coords.z));
        ...
        /*        Tensor<1, data_t> d1_phi_Re, d1_phi_Im;
                FOR(idir) m_deriv.diff1(d1_phi_Re, current_cell, idir,
           c_phi_Re); FOR(idir) m_deriv.diff1(d1_phi_Im, current_cell, idir,
           c_phi_Im);
